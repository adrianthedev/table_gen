class TableGen::SvgFinder
  ...
  def pathname
    ...
    paths = [
      ...
      TableGen::Engine.root.join("app", "assets", "svgs", @filename).to_s,
      TableGen::Engine.root.join("app", "assets", "svgs", "heroicons", "outline", @filename).to_s,
      TableGen::Engine.root.join(@filename).to_s,
    ]
